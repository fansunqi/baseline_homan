...
def track_sequence(images,
    ...
    for image in tqdm(images, desc="frame"):
        ...
        try:
            ...
            # NewSetup = {'right_hand': 1}
            # _, computed_setup, valid_bboxes = verify.check_setup(bboxes, NewSetup)
    ...
    # 先打印一下detected boxes看一下是什么样
    # print("detected_boxes", detected_boxes)
    # detected_boxes {'right_hand': [array([ 92.72766 , 250.2981  ,  75.898636,  77.66199 ], dtype=float32), array([ 90.464584, 251.44456 ,  78.602844,  76.75758 ], dtype=float32), array([ 91.16361 , 251.70259 ,  76.38271 ,  76.691666], dtype=float32), array([ 89.53225, 252.36247,  77.45246,  76.10683], dtype=float32), array([ 89.20303 , 254.36818 ,  77.08365 ,  72.997116], dtype=float32), array([ 84.50846 , 256.4506  ,  79.23057 ,  70.489136], dtype=float32), array([ 82.42264, 259.11426,  81.38725,  67.00745], dtype=float32), array([ 80.414856, 260.75314 ,  84.54353 ,  64.47803 ], dtype=float32), array([ 81.48596, 259.57007,  84.79739,  64.39099], dtype=float32), array([ 77.445435, 256.92703 ,  90.73952 ,  65.112   ], dtype=float32)]}
    # Perform tracking
    for item in setup:
